...
describe('ProductDetailDrawer Component', () => {
    ...
    it('should not render when product is null', () => {
        ...
        expect(screen.queryByText('Tambah ke Keranjang')).not.toBeInTheDocument();
    });
    ...
    it('should render correctly when open with product', () => {
        ...
        expect(screen.getByText('Nasi Goreng dengan telur dan ayam suwir', { exact: false })).toBeInTheDocument();
    ...
    it('should validate required modifiers before adding to cart', () => {
        ...
        const addToCartBtn = screen.getByText('Tambah ke Keranjang').closest('button');
